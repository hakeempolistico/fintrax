...
export default function ActionModals({ me, collection, bills, accounts, loans }: Props) {
 ...
 const config={accounts:{Form:AccountForm,endpoint:'/api/accounts'},loans:{Form:LoanForm,endpoint:'/api/loans'},bills:{Form:BillForm,endpoint:'/api/bills'},transactions:{Form:TransactionForm,endpoint:'/api/transactions'}}[collection]
