    ...
    <form onSubmit={onSubmitHandler}>
      ...
      <div className="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2">
        ...
        <div>
          ...
          <Input
            defaultValue={data.customerAccountNumber ?? ''}
            onChange={(e) => setData({ ...data, customerAccountNumber: e.target.value })}
            type="text"
        ...
        <div>
          ...
          <Select
            ...
            onChange={(value) =>
              setData({ ...data, type: value, ...(value === 'variable' ? { amount: 0 } : {}) })
            }
          />
        </div>
        ...
        <div>
          ...
          <Input
            defaultValue={data.billingPeriodStart ?? ''}
            onChange={(e) => setData({ ...data, billingPeriodStart: Number(e.target.value) })}
            type="number"
            placeholder="1"
        ...
        <div>
          ...
          <Input
            defaultValue={data.billingPeriodEnd ?? ''}
            onChange={(e) => setData({ ...data, billingPeriodEnd: Number(e.target.value) })}
            type="number"
            placeholder="30"
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => setData({ ...data, dueDate: Number(e.target.value) })}
            type="number"
            placeholder="30"
            name="dueDate"
            min="1"
